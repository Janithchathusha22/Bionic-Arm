...
;
const metadata = {
    title: "Bionic Arm Project | EMG-Controlled Prosthetic",
    description: "Affordable EMG-Controlled Bionic Arm – Innovation for Accessible Prosthetics. Final Year Research Project by Nilmini Jayakody, University of Moratuwa.",
    generator: "v0.app",
    icons: {
        icon: [
            {
